...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_4.addWidget(self.unitIDSpinBox, 1, 7, 1, 1)
        ...
        self.unitIDLabel = QtWidgets.QLabel(self.pollingSettingsGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.unitIDLabel.sizePolicy().hasHeightForWidth())
        self.unitIDLabel.setSizePolicy(sizePolicy)
        self.unitIDLabel.setObjectName("unitIDLabel")
        self.gridLayout_4.addWidget(self.unitIDLabel, 0, 7, 1, 1)
        ...
        self.tcpRadioButton.toggled['bool'].connect(self.unitIDSpinBox.setEnabled)
        self.serialRadioButton.toggled['bool'].connect(self.unitIDSpinBox.setDisabled)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.unitIDLabel.setText(_translate("MainWindow", "Unit ID"))
